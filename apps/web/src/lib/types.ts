...
export type Tournament = {
  ...
  viewerPlan?: 'FREE' | 'PREMIER';
  requiresPassword?: boolean;
  stations?: import('./types-platform').Station[];
  referees?: import('./types-platform').Referee[];
  standingAdjustments?: import('./types-platform').StandingAdjustment[];
  _countRegistrations?: { pending?: number; approved?: number; waitlisted?: number };
